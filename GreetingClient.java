                            ...
                            static class Menu {
                                ...
                                public static Menu createCustomerMenu(BufferedReader input) {
                                    return new Menu("Customer Menu",
                                            Arrays.asList("Request a Ride", "View Ride Status", "Accept Bid", "Exit"),
                                            input);
                                }
                            ...
                            private static void handleOfferFare() {
                                try {
                                    ...
                                    if (rideRequestsMessage.startsWith("RIDE_REQUESTS:")) {
                                        ...
                                        String choice = getNonEmptyInput("Enter the number of the ride you want to bid on (or 0 to cancel): ");
