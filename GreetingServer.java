import java.io.*;
                ...
                public class GreetingServer extends Thread {
                    ...
                    static class MenuHandler {
                        ...
                        public void handleAuthMenu(int choice, int userType) throws IOException {
                            switch (choice) {
                                case 1:
                                    handler.processSignup(userType);
                                    break;
                                case 2:
                                    handler.processLogin(userType);
                                    break;
                                default:
                                    handler.out.writeUTF("FAILURE: Invalid authentication choice");
                            }
                        }
                    }
